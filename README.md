...
Use of NLP and machine learning algorithm(logistic regression) for predicting the sentiment of a person based upon their reaction on a particular post they do with hashtags.
